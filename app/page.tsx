...
const locations: MapMarker[] = [
  { id: 1, longitude: 122.4194, latitude: 37.7749, label: 'San Francisco HQ', color: '#0ea5e9' },
...
const windData = [
  { lngLat: [122.4194, 37.7749] as [number, number], direction: 10, speed: 100 },  // SW wind, 12 mph
  { lngLat: [74.006,  40.7128] as [number, number], direction: 180, speed: 8 },   // S wind, 8 mph
  { lngLat: [0.1276, 51.5074] as [number, number], direction: 90, speed: 15 },   // E wind, 15 mph
];
